...
options = {
  ...
  use_odometry = false,                -- Internal Lidar+IMU fusion
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 1,
  ...
  rangefinder_sampling_ratio = 0.55,
...
-- Ceres scan matcher tuning for robust tracking
...
-- Motion filter
TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds = 0.3 --#0.1
